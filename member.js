...
const MemberSchema = mongoose.Schema({
    ...
    Telephone2: {type: String, minlength:10, maxlength:10},
    ...
    children: {
        ...
        gender: {
            1:{type:String,enum: ["Male","Female"]},
            2:{type:String,enum: ["Male","Female"]},
            3:{type:String,enum: ["Male","Female"]},
            4:{type:String,enum: ["Male","Female"]},
            5:{type:String,enum: ["Male","Female"]}
        }
    },
    Gift: {type:String},
    Next_Of_Kin: {
